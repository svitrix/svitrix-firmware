...
export function LivePreview({ variant = "page", showControls = false }: LivePreviewProps) {
  const { t } = useTranslation();
  const canvasRef = useRef<HTMLCanvasElement>(null);
  const running = useRef(true);

  // Controls never render in the compact variant.
  const controlsVisible = showControls && variant !== "compact";
  ...
  return (
    <div class={variant === "compact" ? styles.compact : styles.page}>
      {controlsVisible && (
