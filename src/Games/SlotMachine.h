...
constexpr int NUM_REELS = 3;
constexpr int REEL_WIDTH = 8;
constexpr int REEL_HEIGHT = 8;

constexpr int LEFT_MARGIN = 2;
constexpr int GAP_BETWEEN_REELS = 2;
...
class SlotMachine_
{
  private:
    ...
    SlotMachine_(const SlotMachine_&) = delete;
    SlotMachine_& operator=(const SlotMachine_&) = delete;
    SlotMachine_(SlotMachine_&&) = delete;
    SlotMachine_& operator=(SlotMachine_&&) = delete;
