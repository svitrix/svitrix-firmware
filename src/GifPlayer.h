...
{
    // ── Constants ────────────────────────────────────────────────────────
    static constexpr int ERROR_NON = 0;
    static constexpr int ERROR_FILEOPEN = 1;
    static constexpr int ERROR_FILENOTGIF = 2;
    static constexpr int ERROR_BADGIFFORMAT = 3;
    static constexpr int ERROR_UNKNOWNCONTROLEXT = 4;
    static constexpr int ERROR_FINISHED = 5;
    static constexpr int WIDTH = 32;
    static constexpr int HEIGHT = 8;
    static constexpr const char *GIFHDRTAGNORM = "GIF87a";
    static constexpr const char *GIFHDRTAGNORM1 = "GIF89a";
    static constexpr int GIFHDRSIZE = 6;
    static constexpr int COLORTBLFLAG = 0x80;
    static constexpr int INTERLACEFLAG = 0x40;
    static constexpr int TRANSPARENTFLAG = 0x01;
    static constexpr int NO_TRANSPARENT_INDEX = -1;
    static constexpr int DISPOSAL_NONE = 0;
  ...
  public:
    ...
    unsigned long parseTableBasedImage()
    {
        ...
        while (dataBlockSize != 0)
        {
            backUpStream(1);
            dataBlockSize++;
            if (offset + dataBlockSize <= static_cast<int>(sizeof(lzwImageData)))
            {
    ...
    static constexpr int LZW_MAXBITS = 10;
    static constexpr int LZW_SIZTABLE = (1 << LZW_MAXBITS);
