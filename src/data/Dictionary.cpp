...
const char HAmodel[] PROGMEM = {"SVITRIX"};
...
const char HAeffectOptions[] PROGMEM = {"Random;Slide Down;Dim;Zoom;Rotate;Pixelate;Curtain;Ripple;Blink;Reload;Fade;Slide Up;Slide Left;Slide Right"};
