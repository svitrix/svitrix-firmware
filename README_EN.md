...
[Quick Start](#quick-start) · [Features](#features) · [API](#api) · [Documentation](https://xe1e.github.io/svitrix-firmware-XE1E/en/) · [FAQ](#faq)
...
1. **Flash** — connect the Ulanzi TC001 via USB and use the [online flasher](https://xe1e.github.io/svitrix-firmware-XE1E/en/flasher)
...
For detailed instructions, see the [Quick Start Guide](https://xe1e.github.io/svitrix-firmware-XE1E/en/quickstart).
...
Supported I2C sensors: BME280, BMP280, HTU21DF, SHT31 (auto-detected at startup). Full hardware reference: [Hardware Guide](https://xe1e.github.io/svitrix-firmware-XE1E/en/hardware).
...
More answers: [FAQ](https://xe1e.github.io/svitrix-firmware-XE1E/en/faq)
