If you want to remove SVITRIX from your Ulanzi TC001 you need to flash the original Firmware.


## Method 1
1. Download the dump of the [original firmware](https://raw.githubusercontent.com/svitrix/svitrix-firmware/main/docs/assets/ulanzi_original_firmware.bin)
...
2. Download the dump of the [original firmware](https://raw.githubusercontent.com/svitrix/svitrix-firmware/main/docs/assets/ulanzi_original_firmware.bin)
